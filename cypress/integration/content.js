describe('Fundación Soy Cuerpo - Content', () => {
  it('/', () => {
    ...
    cy.findByRole('heading', { name: /alianzas y colaboraciones/i }).should(
      'exist'
    );
  });
  ...
  it('/donaciones', () => {
    ...
    cy.findByRole('heading', { name: /donación online/i }).should('exist');
  ...
  it('/departamentos/plataformas', () => {
    ...
    cy.findByRole('heading', { name: /departamento de plataformas/i }).should(
      'exist'
    );
    cy.findByRole('heading', { name: /manifiesto/i }).should('exist');
  });
  ...
  it('/departamentos/salud', () => {
    ...
    cy.findByRole('heading', { name: /departamento de salud/i }).should(
      'exist'
    );
    cy.findByRole('heading', { name: /manifiesto/i }).should('exist');
  });
